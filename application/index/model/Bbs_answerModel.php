...
class Bbs_answerModel extends Model{
    ...
    public function insertOne($userID,$questionID,$question){
        $data = [];
        $data['userID'] = $userID;
    ...
    public function insertOneNew($userID,$questionID,$question,$appointID){
        $data = [];
        $data['userID'] = $userID;
        $data['questionID'] = $questionID;
        $data['content'] = $question;
